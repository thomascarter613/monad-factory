...
title: "ADR-0002: Use monad as the Public Repo Control Plane"
...
# ADR-0002: Use monad as the Public Repo Control Plane
...
Monad Factory accepts this decision as part of the v1 platform foundation: **Use monad as the Public Repo Control Plane**.
