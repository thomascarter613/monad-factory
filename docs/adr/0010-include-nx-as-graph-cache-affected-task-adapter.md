...
title: "ADR-0010: Include Nx as Graph, Cache, and Affected-Task Adapter"
...
# ADR-0010: Include Nx as Graph, Cache, and Affected-Task Adapter
...
Monad Factory accepts this decision as part of the v1 platform foundation: **Include Nx as Graph, Cache, and Affected-Task Adapter**.
