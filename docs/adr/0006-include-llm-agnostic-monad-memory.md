...
title: "ADR-0006: Include LLM-Agnostic Monad Memory"
...
Monad Factory accepts this decision as part of the v1 platform foundation: **Include LLM-Agnostic Monad Memory**.
