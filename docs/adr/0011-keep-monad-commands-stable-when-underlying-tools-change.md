...
title: "ADR-0011: Keep monad Commands Stable When Underlying Tools Change"
...
Monad Factory accepts this decision as part of the v1 platform foundation: **Keep monad Commands Stable When Underlying Tools Change**.
