...
if "Foundation Check" not in index_text:
...
if '"docs/cli/foundation-check.md",' not in check_text:
    check_text = check_text.replace(
        '"docs/cli/workspace-inspection.md",',
        '"docs/cli/workspace-inspection.md",\n        "docs/cli/foundation-check.md",',
    )

if 'cargo run -p monad-cli -- check foundation | grep "engine: native" >/dev/null' not in check_text:
    check_text = check_text.replace(
...
print("foundation check engine generated")
